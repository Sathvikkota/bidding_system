...
from bidding_system import settings
from .forms import CustomRegisterForm
from django.contrib import messages
from .models import Placement, PlacementBid, Bid, Company, Send_email, Send_feedback
...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            msg = "Password doesnt meet requirements or doesnt match.Try again"
...
def send_email(request):
    if request.method == "POST":
        ...
        send_email = Send_email(email=email,feedback=feedback)
        send_email.save()

        subject = 'FEEDBACK FORM DATA '

        send_mail(subject, feedback, email,['2100030279cseh@gmail.com'], fail_silently=False)
